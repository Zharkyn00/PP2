...
mike_clock = pygame.transform.scale(pygame.image.load("clock elem/clock (1).png"), (800, 600))
rightarm = pygame.image.load("clock elem/rightarm.png")
leftarm = pygame.image.load("clock elem/leftarm.png")
...
while running:
    ...
    sc.blit(rotated_rightarm, rightarmrect)
    ...
    sc.blit(rotated_leftarm, leftarmrect)
